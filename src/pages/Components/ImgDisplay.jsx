...
const CloseButton = (props) => {
  return (
    <div datakey={props.datakey} onClick={props.onClose} style={{margin: '1px'}}>
    ...
    <div>
      {
        props.files.map((image, key) => {
          ...
          console.log(url)
          return (
            <Card key={image.size} style={{maxWidth: '25vw'}}>
              <CardHeader style={{maxHeight: '25vh', padding:'3px', height: '33px'}} action={<CloseButton datakey={key} onClose={props.onClose}/>}/>
              <CardMedia
                component="img"
                image={url}
                style={imgStyle}
